...
g,!1);window.removeEventListener("deviceorientation",m,!1);window.removeEventListener("deviceorientation",this.update.bind(this),!1);c.domElement.removeEventListener("touchstart",k,!1);c.domElement.removeEventListener("touchmove",f,!1);c.enabled=!1};this.update=function(a){if(!1!==c.enabled){var b=c.deviceOrientation.alpha?e.MathUtils.degToRad(c.deviceOrientation.alpha)+c.alphaOffsetAngle:0,h=c.deviceOrientation.beta?e.MathUtils.degToRad(c.deviceOrientation.beta):0,f=c.deviceOrientation.gamma?e.MathUtils.degToRad(c.deviceOrientation.gamma):
0,E=c.screenOrientation?e.MathUtils.degToRad(c.screenOrientation):0,v=c.camera.quaternion,m=new e.Vector3(0,0,1),g=new e.Euler,k=new e.Quaternion,J=new e.Quaternion(-Math.sqrt(.5),0,0,Math.sqrt(.5)),l=new e.Quaternion,ca=new e.Quaternion;if(0==c.screenOrientation){var p=new e.Vector3(1,0,0);l.setFromAxisAngle(p,-n)}else 180==c.screenOrientation?(p=new e.Vector3(1,0,0),l.setFromAxisAngle(p,n)):90==c.screenOrientation?(p=new e.Vector3(0,1,0),l.setFromAxisAngle(p,n)):-90==c.screenOrientation&&(p=new e.Vector3(0,
...
c,d.get?d:{enumerable:!0,get:function(){return a[c]}})}});b["default"]=a;return Object.freeze(b)}(u);u="^0.164.1".replace(/[^0-9.]/g,"");var M={ORBIT:0,DEVICEORIENTATION:1},q={UNKNOWN:0,NORMAL:1,CARDBOARD:2,STEREO:3},y={Info:"data:image/png;base64,",
...
d&&(d.dispose(),b.material=null)}this.infospotAnimation.stop();this.fadeInAnimation.stop();this.fadeOutAnimation.stop();this.enterTransition.stop();this.leaveTransition.stop();this.dispatchEvent({type:"panolens-viewer-handler",method:"onPanoramaDispose",data:this});a(this);this.parent&&this.parent.remove(this)};var z=function(a,b,c){b=b||new e.SphereGeometry(5E3,60,40);c=c||new e.MeshBasicMaterial({opacity:0,transparent:!0});c=l.call(this,b,c)||this;c.src=a;c.radius=5E3;return c};$jscomp.inherits(z,
...
a instanceof e.CubeTexture&&a.dispose();l.prototype.dispose.call(this)};var ba=function(){var a=G.call(this)||this;for(var b=[],c=0;6>c;c++)b.push(y.WhiteTile);return a};$jscomp.inherits(ba,G);var w=function(a,b){b=void 0===b?{}:b;var c=new e.SphereGeometry(5E3,60,40);var d=new e.MeshBasicMaterial({opacity:0,transparent:!0});c=l.call(this,c,d)||this;c.src=a;c.options={videoElement:document.createElement("video"),loop:!0,muted:!0,autoplay:!1,playsinline:!0,crossOrigin:"anonymous"};Object.assign(c.options,
...
z);r.prototype.add=function(a){if(1<arguments.length){for(var b=0;b<arguments.length;b++)this.add(arguments[b]);return this}a instanceof p&&(a.material.depthTest=!1);z.prototype.add.call(this,a)};r.createGeometry=function(a,b){return new e.PlaneGeometry(a,a*b)};r.createMaterial=function(a){var b=Object.assign({},da),c=b.uniforms;c.zoom.value=a;c.opacity.value=0;return new e.ShaderMaterial({uniforms:c,vertexShader:b.vertexShader,fragmentShader:b.fragmentShader,side:e.BackSide,transparent:!0})};r.prototype.registerMouseEvents=
function(){this.container.addEventListener("mousedown",this.onMouseDown.bind(this),{passive:!0});this.container.addEventListener("mousemove",this.onMouseMove.bind(this),{passive:!0});this.container.addEventListener("mouseup",this.onMouseUp.bind(this),{passive:!0});this.container.addEventListener("touchstart",this.onMouseDown.bind(this),{passive:!0});this.container.addEventListener("touchmove",this.onMouseMove.bind(this),{passive:!0});this.container.addEventListener("touchend",this.onMouseUp.bind(this),
{passive:!0});this.container.addEventListener("mousewheel",this.onMouseWheel.bind(this),{passive:!1});this.container.addEventListener("DOMMouseScroll",this.onMouseWheel.bind(this),{passive:!1});this.container.addEventListener("contextmenu",this.onContextMenu.bind(this),{passive:!0})};r.prototype.unregisterMouseEvents=function(){this.container.removeEventListener("mousedown",this.onMouseDown.bind(this),!1);this.container.removeEventListener("mousemove",this.onMouseMove.bind(this),!1);this.container.removeEventListener("mouseup",
this.onMouseUp.bind(this),!1);this.container.removeEventListener("touchstart",this.onMouseDown.bind(this),!1);this.container.removeEventListener("touchmove",this.onMouseMove.bind(this),!1);this.container.removeEventListener("touchend",this.onMouseUp.bind(this),!1);this.container.removeEventListener("mousewheel",this.onMouseWheel.bind(this),!1);this.container.removeEventListener("DOMMouseScroll",this.onMouseWheel.bind(this),!1);this.container.removeEventListener("contextmenu",this.onContextMenu.bind(this),
!1)};r.prototype.onMouseDown=function(a){switch(a.touches&&a.touches.length||1){case 1:var b=0<=a.clientX?a.clientX:a.touches[0].clientX;a=0<=a.clientY?a.clientY:a.touches[0].clientY;this.dragging=!0;this.userMouse.set(b,a);break;case 2:b=a.touches[0].pageX-a.touches[1].pageX,a=a.touches[0].pageY-a.touches[1].pageY,this.userMouse.pinchDistance=Math.sqrt(b*b+a*a)}this.onUpdateCallback()};r.prototype.onMouseMove=function(a){switch(a.touches&&a.touches.length||1){case 1:var b=0<=a.clientX?a.clientX:
a.touches[0].clientX;a=0<=a.clientY?a.clientY:a.touches[0].clientY;var c=.4*e.MathUtils.degToRad(b-this.userMouse.x),d=.4*e.MathUtils.degToRad(a-this.userMouse.y);this.dragging&&(this.quatA.setFromAxisAngle(this.vectorY,c),this.quatB.setFromAxisAngle(this.vectorX,d),this.quatCur.multiply(this.quatA).multiply(this.quatB),this.userMouse.set(b,a));break;case 2:b=a.touches[0].pageX-a.touches[1].pageX,a=a.touches[0].pageY-a.touches[1].pageY,this.addZoomDelta(this.userMouse.pinchDistance-Math.sqrt(b*b+
a*a))}};r.prototype.onMouseUp=function(){this.dragging=!1};r.prototype.onMouseWheel=function(a){a.preventDefault();a.stopPropagation();var b=0;void 0!==a.wheelDelta?b=a.wheelDelta:void 0!==a.detail&&(b=-a.detail);this.addZoomDelta(b);this.onUpdateCallback()};r.prototype.addZoomDelta=function(a){var b=this.material.uniforms,c=.1*this.size,d=10*this.size;b.zoom.value+=a;b.zoom.value<=c?b.zoom.value=c:b.zoom.value>=d&&(b.zoom.value=d)};r.prototype.onUpdateCallback=function(){this.frameId=window.requestAnimationFrame(this.onUpdateCallback.bind(this));
...
magFilter:e.NearestFilter,format:e.RGBAFormat});h.scissorTest=!0;h.texture.generateMipmaps=!1;var g=new e.Vector2(.441,.156),k=(new e.PlaneGeometry(1,1,10,20)).deleteAttribute("normal").toNonIndexed(),l=k.attributes.position.array,m=k.attributes.uv.array;k.attributes.position.count*=2;k.attributes.uv.count*=2;var p=new Float32Array(2*l.length);p.set(l);p.set(l,l.length);var q=new Float32Array(2*m.length);q.set(m);q.set(m,m.length);m=new e.Vector2;l=l.length/3;for(var f=0,t=p.length/3;f<t;f++){m.x=
...
"10px";b.style.left="10px";b.style.opacity="0.5";b.style.cursor="pointer";b.id="panolens-view-indicator-container";a.container.appendChild(b);var c=b.querySelector("#indicator");a.addUpdateCallback(function(){a.radius=.225*a.viewIndicatorSize;a.currentPanoAngle=a.camera.rotation.y-e.MathUtils.degToRad(90);a.fovAngle=e.MathUtils.degToRad(a.camera.fov);a.leftAngle=-a.currentPanoAngle-a.fovAngle/2;a.rightAngle=-a.currentPanoAngle+a.fovAngle/2;a.leftX=a.radius*Math.cos(a.leftAngle);a.leftY=a.radius*Math.sin(a.leftAngle);
...
this.widget.videoElement.appendChild(b):this.widget.barElement.appendChild(b);return b};g.prototype.clearAllCache=function(){e.Cache.clear()};"164"!=e.REVISION&&console.warn("three.js version is not matched. Please consider use the target revision 164");window.TWEEN=t;k.BasicPanorama=ba;k.CONTROLS=M;k.CONTROL_BUTTONS={FULLSCREEN:"fullscreen",SETTING:"setting",VIDEO:"video"};k.CameraPanorama=H;k.CubePanorama=G;k.CubeTextureLoader=Z;k.DataImage=y;k.EmptyPanorama=aa;k.GoogleStreetviewPanorama=F;k.ImageLittlePlanet=
N;k.ImageLoader=S;k.ImagePanorama=z;k.Infospot=p;k.LittlePlanet=r;k.MODES=q;k.Media=D;k.OUTPUTS={NONE:"none",CONSOLE:"console",OVERLAY:"overlay"};k.Panorama=l;k.REVISION="0";k.Reticle=B;k.THREE_REVISION="164";k.THREE_VERSION=u;k.TextureLoader=Q;k.VERSION="0.0.13";k.VideoPanorama=w;k.Viewer=g;k.Widget=x;Object.defineProperty(k,"__esModule",{value:!0})});
